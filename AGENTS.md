...
`assemblies/assemblies-action-ili2db/target` and
`assemblies/assemblies-transform-ili2db/target`.
...
`$HOME/.cache/hop-ili2db`, installs both ZIPs into `target/e2e/hop` and runs the
