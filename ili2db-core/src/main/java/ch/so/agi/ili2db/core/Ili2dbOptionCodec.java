...
public final class Ili2dbOptionCodec {
  private Ili2dbOptionCodec() {}

  public static String encode(List<Ili2dbOptionEntry> entries) {
  ...
  public static List<Ili2dbOptionEntry> decode(String encoded) {
    List<Ili2dbOptionEntry> entries = new ArrayList<>();
